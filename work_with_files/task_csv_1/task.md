...
Требуется найти и прочитать этот единственный файл со структурированными данными (это таблица 10х10, разделителем являются запятые), а в качестве ответа указать число, находящееся на 5 строке и 3 позиции (имеются ввиду позиции, а не индексы).